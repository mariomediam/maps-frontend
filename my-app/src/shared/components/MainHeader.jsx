...
const MainHeader = () => {
	...
	return (
		// <header className="flex justify-between items-center bg-header p-3">
		...
		//       <h1 className="text-1xl tracking-tight lg:text-2xl font-bold pb-0 mb-0 leading-[1.1]">
		//         Sistema para el registro de incidencias
		//       </h1>
		//       <p className="text-sm text-[12px]  lg:text-sm leading-tight">
		...
		//   <button
		//     type="button"
		//     className="text-secondary  hover:bg-primary focus:ring-2 focus:outline-none focus:ring-secondary font-medium rounded-lg text-[10px]  px-4 py-2 text-center inline-flex items-center me-2 cursor-pointer border border-secondary"
